...
exports.SeguridadInicial1700000000000 = void 0;
class SeguridadInicial1700000000000 {
    constructor() {
        this.name = 'SeguridadInicial1700000000000';
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX "idx_asignacion_docente_franja" ON "audit_log" ("entidad", "usuario_id")`);
    }
...
exports.SeguridadInicial1700000000000 = SeguridadInicial1700000000000;
//# sourceMappingURL=1700000000000-seguridad-inicial.js.map