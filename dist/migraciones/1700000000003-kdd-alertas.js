...
exports.KddAlertas1700000000003 = void 0;
class KddAlertas1700000000003 {
    constructor() {
        this.name = 'KddAlertas1700000000003';
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_resultado_kdd_periodo" ON "resultado_kdd" ("periodo_id")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_alerta_periodo_nivel" ON "alerta" ("periodo_id", "nivel")`);
    }
...
exports.KddAlertas1700000000003 = KddAlertas1700000000003;
//# sourceMappingURL=1700000000003-kdd-alertas.js.map