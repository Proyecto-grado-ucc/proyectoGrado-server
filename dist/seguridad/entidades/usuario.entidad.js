...
const rol_entidad_1 = require("./rol.entidad");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => rol_entidad_1.Rol, { eager: true, onDelete: 'RESTRICT' }),
    (0, typeorm_1.JoinColumn)({ name: 'rol_id' }),
    __metadata("design:type", rol_entidad_1.Rol)
...
__decorate([
    (0, typeorm_1.OneToMany)('Sesion', 'usuario'),
