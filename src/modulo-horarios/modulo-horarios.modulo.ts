...
@Module({
  imports: [
    TypeOrmModule.forFeature([Aula, NivelIdioma, Curso, Grupo, FranjaHoraria, Disponibilidad, Docente]),
    SeguridadModulo,
  ],
  providers: [
    AulasServicio,
  ...
  exports: [NivelesServicio, CursosServicio, GruposServicio, FranjasServicio, DisponibilidadesServicio],
})
